              ...
              >
                <div className="flex items-center space-x-4">
                  <div className={`rounded-xl p-3 ${
                    selectedDepartment === dept.id ? 'bg-black/10' : 'bg-black/30'
                  }`}>
                    {React.cloneElement(dept.icon, { 
                      className: selectedDepartment === dept.id ? 'text-black' : 'text-yellow-400'
                    })}
                  </div>
                  <div>
                    <h3 className="font-bold mb-1">{dept.name}</h3>
                    <p className={`text-sm ${
                      selectedDepartment === dept.id ? 'text-black/70' : 'text-gray-400'
                    }`}>
                      {dept.description}
                    </p>
                  </div>
              ...
              >
                ...
                <button
                  ...
                  className="bg-yellow-400 text-black px-6 py-3 rounded-xl font-medium 
                    hover:bg-yellow-300 transition-all duration-300 w-full"
                >
                  Apply Now
                </button>
              </div>
                ...
                <div className="flex justify-between items-start mb-6">
                  <div>
                    ...
                    <p className="text-gray-400">
                      Upload the required documentation below
                    </p>
                  </div>
                  <button
